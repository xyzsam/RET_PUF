...
%function [peakLifetimes lineLifetimes L P imageMat T finalLifetime H factor] = getLifetimesHough(t,y,dx,pks)
function [peakLifetimes L imageMat T R H finalLifetime factor] = getLifetimesHough(t,y,dx,pks)
  import hough.houghstats;
